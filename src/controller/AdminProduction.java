...
/**
 * Servlet implementation class AdminProduction
 */
@WebServlet("/AdminProduction")
public class AdminProduction extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher1 = request.getRequestDispatcher("/Admin/productionA.jsp");
